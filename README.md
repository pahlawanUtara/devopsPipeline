[![Build Status](https://dev.azure.com/shanyung/MyBestMoveEver/_apis/build/status/pahlawanUtara.devopsPipeline?branchName=master)](https://dev.azure.com/shanyung/MyBestMoveEver/_build/latest?definitionId=1&branchName=master)
